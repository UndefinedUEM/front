...
const MemberDeleteConfirmationDialog: React.FC<
  MemberDeleteConfirmationDialogProps
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Você tem certeza que deseja remover <b>{memberName}</b> do quadro de
...
export default MemberDeleteConfirmationDialog;
