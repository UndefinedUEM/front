    ...
    <Box p={4}>
      <Container maxW="container.lg" textAlign="center">
        ...
        <Text fontSize={{ base: 'lg', md: 'xl' }} color="gray.600" mb={8}>
          Olá {firstName}! Bem-vindo ao sistema de presença do grupo. Use os
          atalhos abaixo para cadastrar um novo escoteiro, criar uma nova lista
          de chamada ou consultar o histórico de eventos.
        </Text>
      </Container>
      ...
      <Box id="acoes" pb={12}>
        ...
        <Flex justify="center" align="stretch" wrap="wrap" gap={10}>
